...
def parse_args() -> Dict:
    ...
    parser.add_argument(
        "--project", type=str, default=None, help="Project name (default: from env or 'default')"
    )
    parser.add_argument(
        "--data-dir", type=str, default=None, help="Data directory (default: from env or './data')"
    )
    parser.add_argument(
